...
public class MyLinkedList<E> {
    ...
    //Phần tử đầu tiên của danh cách liên kết
    private Node head;
    ...
    public void addFirst(E element){
        ...
        //head.next trỏ dến temp
        head.next = temp;
        numNodes++;
    }
    public void addLast(E element) {
        //Khai báo 1 biens temp trỏ đến head
        Node temp = head;
    ...
    public void add(int index, E element) {
        //Khai báo biến temp trỏ đế head
        Node temp = head;
        //Khai báo biến node là holder
        Node holder;
    ...
    public boolean remove(E element) {
        ...
        if (head.data.equals(element)) {
            ...
            Node temp = head;
            while (temp.next != null) {
                //Nếu như tồn tại 1 phần tử data bàng data truyền vào thì node đó sẽ bị remove
    ...
    public MyLinkedList<E> clone(){
        ...
        Node temp = head;
        //add temp vào danh sách trả về để nó là head
